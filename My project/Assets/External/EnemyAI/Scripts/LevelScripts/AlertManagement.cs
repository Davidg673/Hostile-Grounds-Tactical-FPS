...
public class AlertManagement : MonoBehaviour
{
	...
	[Range(0, 100)] public float alertRadius;
	...
	private Transform target;       // The current alert position.
	...
	private void AlertNearby(Vector3 origin, Transform target, int wave = 0)
	{
	...
	public void RootAlertNearby(Transform target)
	{
		this.target = target;
		alert = true;
	}
